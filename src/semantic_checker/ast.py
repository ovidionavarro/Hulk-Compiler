...
class ParameterNode(Node):
    def __init__(self,name:str,type:str='Any'):
        self.name=name
        self.type=type
class FunctionNode(StatementNode):
    def __init__(self,name:str,parameters:List[ParameterNode],corpus:ExpressionNode,type:str='Any'):
        self.name=name
